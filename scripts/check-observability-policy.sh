...
required_collector=(
  'client_ca_file: ${env:FORGE_OTEL_RECEIVER_CLIENT_CA_FILE}'
  'ca_file: ${env:FORGE_OTEL_EXPORT_CA_FILE}'
  'cert_file: ${env:FORGE_OTEL_EXPORT_CERT_FILE}'
  'key_file: ${env:FORGE_OTEL_EXPORT_KEY_FILE}'
