...
func normalizeKey(raw string) ([]byte, error) {
	if raw == "" {
		return nil, errors.New("FORGE_CRYPTO_KEY is required")
	}
	...
	return nil, errors.New("FORGE_CRYPTO_KEY must contain at least 32 bytes or be base64 encoding of at least 32 bytes")
}
