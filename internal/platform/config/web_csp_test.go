...
func TestApplyEnvironmentLoadsWebCSPControls(t *testing.T) {
	t.Setenv("FORGE_WEB_CSP_FRAME_SOURCES", "https://one.example.cn,https://two.example.cn")
	t.Setenv("FORGE_WEB_CSP_WUJIE_ENABLED", "true")
	t.Setenv("FORGE_WEB_CSP_WUJIE_APPROVAL_REF", "SEC-2026-002")
	cfg := Default()
