...
func PlatformRules() map[string][]string {
	return map[string][]string{
		...
		forgev1.OperationPlatformServiceListEmergencyAccess:        {"system.emergency_access.read"},
		forgev1.OperationPlatformServiceCreateEmergencyAccess:      {"system.emergency_access.manage"},
		forgev1.OperationPlatformServiceRevokeEmergencyAccess:      {"system.emergency_access.manage"},
